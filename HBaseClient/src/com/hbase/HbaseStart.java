...
public class HbaseStart
{
	...
	public static void createTable() throws IOException
	{
		...
		try {
			// HBaseConfiguration hc = new HBaseConfiguration(new Configuration());
			  ...
			  HTableDescriptor ht = new HTableDescriptor("Group2SensordataBala"); 
	...
	public static void insertTable() throws IOException{
		...
		config.clear();
         ...
         String latitude="",longitude="",Date="",x="",y="",z="";
		  ...
		  HTable table = new HTable(config, "Group2SensordataBala");
	...
	public static void retrieveTable() throws IOException{
		...
		config.clear();
         ...
         config.set("hbase.master", "134.193.136.127:60010");
		  ...
		  HTable table = new HTable(config, "Group2SensordataBala3");
	...
	public static void deleteTable() throws IOException{
		...
		config.clear();
         ...
         HBaseAdmin admin = new HBaseAdmin(config);
         admin.disableTable("Group2SensordataBala");
         admin.deleteTable("Group2SensordataBala");
