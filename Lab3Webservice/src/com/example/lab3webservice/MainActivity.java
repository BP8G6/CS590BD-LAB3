		...
		setContentView(R.layout.activity_main);
	       ...
	       btn_create.setOnClickListener(new View.OnClickListener() {
	            ...
	            public void onClick(View v) {
	        		...
	        		url = "http://134.193.136.127:8080/HbaseWS/jaxrs/generic/hbaseCreate/"+tablename+"/"+column_families;
	       ...
	       btn_insert.setOnClickListener(new View.OnClickListener() {
	            ...
	            public void onClick(View v) {
	        		  ...
	        		  EditText insert_tablename = (EditText) findViewById(R.id.editText1);
	        	   		...
	        	   		String tablename = insert_tablename.getText().toString();
	        	   		String column_families = insert_column.getText().toString();
	        		url = "http://134.193.136.127:8080/HbaseWS/jaxrs/generic/hbaseInsert/"+tablename+"/-home-cloudera-sensor.txt/"+column_families;
	            	Intent intent = new Intent(Intent.ACTION_VIEW); 
	       			     intent.setData(Uri.parse(url));
	       			startActivity(intent);
	       ...
	       btn_retrieve.setOnClickListener(new View.OnClickListener() {
	            ...
	            public void onClick(View v) {
	        		...
	        		url = "http://134.193.136.127:8080/HbaseWS/jaxrs/generic/hbaseRetrieveAll/"+tablename;
	            	Intent intent = new Intent(Intent.ACTION_VIEW); 
	       			     intent.setData(Uri.parse(url));
	       			startActivity(intent);
	       ...
	       btn_delete.setOnClickListener(new View.OnClickListener() {
	            ...
	            public void onClick(View v) {
	        		...
	        		url = "http://134.193.136.127:8080/HbaseWS/jaxrs/generic/hbasedeletel/"+tablename;	            	
	            	Intent intent = new Intent(Intent.ACTION_VIEW); 
	       			     intent.setData(Uri.parse(url));
	       			startActivity(intent);
